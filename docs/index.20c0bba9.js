 ...
 * limitations under the License.
 */
class Ks{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qs(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ot(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Xs(e,t,n){Qs(e,n),Zs(e,(e=>Ot(e,t)))}function Js(e,t,n){Qs(e,n),Zs(e,(e=>Lt(e,t)||Lt(t,e)))}function Zs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(er(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function er(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&He("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Hr={};let jr=!1;function Br(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Ir(r,s),h=l.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=Ir(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Gs("Invalid Firebase Database URL",l),At(l.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Hr[t.name];s||(s={},Hr[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new tr(e,jr,n,i),s[e.toURLString()]=r,r}(h,e,c,new st(e.name,n));return new zr(u,e)}class zr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Pr(this._repo,Tt())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Hr[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ur(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}jt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},jt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ne="9.6.10",Z(new L("database",((e,{instanceIdentifier:t})=>Br(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.7",e),ie("@firebase/database","0.12.7","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const Vr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"}));class $r{constructor(e,t){this.username=e,this.password=t}getUsername(){return this.username}getPassword(){return this.password}}const Yr=document.querySelector("#travel"),Gr=document.querySelector("#sport"),Kr=document.querySelector("#gaming"),Qr=document.querySelector("#travel-chat"),Xr=document.querySelector("#sport-chat"),Jr=document.querySelector("#gaming-chat");let Zr=Yr,eo=Qr,to=!0,no=!1,io=!1;const so=e=>{"travel-forum"==e?(Zr=Yr,eo=Qr,Yr.style.display="flex",Gr.style.display="none",Kr.style.display="none",to=!0,no=!1,io=!1,vo()):"sport-forum"==e?(Zr=Gr,eo=Xr,Yr.style.display="none",Gr.style.display="flex",Kr.style.display="none",to=!1,no=!0,io=!1,vo()):"gaming-forum"==e&&(Zr=Kr,eo=Jr,Yr.style.display="none",Gr.style.display="none",Kr.style.display="flex",to=!1,no=!1,io=!0,vo())},ro=e=>{const t=document.querySelector(".user"),n=document.createElement("div"),i=document.createElement("div"),s=document.createElement("h5"),r=document.createElement("h5"),o=document.createElement("p"),a=document.createElement("button"),l=document.createElement("div");s.innerText=e.username,r.innerText=e.timestamp,o.innerText=e.message,a.innerText="X",a.className="delete-btn",n.className="user-div",i.className="mess-div",l.className="message-container",l.id=e.id,n.append(s),n.append(r),i.append(o),e.username==t.innerText&&e.userId==t.id&&(i.append(a),a.addEventListener("click",(()=>{console.log("delete button clicked"),console.log(e.id),console.log(Zr.id);const t=Rr(Vr,"/messages/"+Zr.id+"/"+e.id);console.log(t),Mr(t)}))),l.append(n),l.append(i),eo.prepend(l),Zr.append(eo),a.addEventListener("click",(()=>{console.log("delete button clicked"),console.log(e.id),console.log(Zr.id);const t=Rr(Vr,"/messages/"+Zr.id+"/"+e.id);console.log(t),Mr(t)}))};class oo{constructor(e,t,n,i,s){this.id=e,this.username=t,this.message=n,this.timestamp=i,this.userId=s}clearChat(){document.querySelector(`#${this.id}`).remove()}}const ao=Rr(Vr,"/messages/travel"),lo=Rr(Vr,"messages/sport"),ho=Rr(Vr,"messages/gaming"),co=Rr(Vr,"/users");let uo;const po=document.querySelectorAll(".forum-btn"),_o=document.querySelector(".user"),fo=document.querySelector("#message"),go=document.querySelector("#add-message-btn");let mo=[];const yo=()=>{!0===to?uo=ao:!0===no?uo=lo:!0===io&&(uo=ho)},vo=()=>{yo(),Wr(uo,(e=>{const t=e.val();console.log(t);for(const e of mo)e.clearChat();mo=[];for(const e in t)mo.push(new oo(e,t[e].username,t[e].message,t[e].timestamp,t[e].userId));console.log(mo);for(const e of mo)ro(e)}))},Co=()=>{let e;return Wr(co,(t=>{e=t.val(),console.log(e)})),e};Co(),new class{constructor(){this.signInForm=document.querySelector("#login-form"),this.signUpForm=document.querySelector("#signup-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),document.querySelector("#signin-btn").addEventListener("click",this.validator.bind(this)),document.querySelector("#btn-signup-ui").addEventListener("click",this.hideUI.bind(this))}validator(e){if(e.preventDefault(),console.log("validator invoked"),console.log(this.username.value),console.log(this.password.value),this.username.value.length>=4&&this.password.value.length>=4){const e=Co();if(e){for(const t in e)if(this.username.value==e[t].username&&this.password.value==e[t].password){console.log("login success");const n=document.querySelector(".user");return n.textContent=e[t].username,n.setAttribute("id",t),void this.clearForm()}console.log("login failed"),this.clearForm()}}else console.log("username/password length is less than 4 characters"),this.clearForm()}hideUI(e){e.preventDefault(),this.clearForm(),this.signInForm.style.display="none",this.signUpForm.style.display="flex"}clearForm(){this.signInForm.reset()}},new class{constructor(){this.usernameInField=document.querySelector("#new_username"),this.passwordInField=document.querySelector("#new_password"),this.repeatPasswordInField=document.querySelector("#repeat_password"),this.signUpform=document.querySelector("#signup-form"),this.signInForm=document.querySelector("#login-form"),document.querySelector("#signup-btn").addEventListener("click",this.validateForm.bind(this)),document.querySelector("#btn-display-signin").addEventListener("click",this.hideUI.bind(this))}validateForm(e){e.preventDefault();const t=Co();let n=[];for(const e in t)n.push(t[e].username);this.usernameInField.value.length<4||this.passwordInField.value.length<4||this.repeatPasswordInField.value.length<4?alert("username/password length is less than 4 characters"):n.includes(this.usernameInField.value)?alert("username already exists"):this.passwordInField.value==this.repeatPasswordInField.value?(alert("signup success"),this.initNewUser(new $r(this.usernameInField.value,this.passwordInField.value))):alert("password does not match")}hideUI(e){e.preventDefault(),console.log("hideUI invoked"),this.signUpform.style.display="none",this.signInForm.style.display="flex"}initNewUser(e){console.log("initNewUser invoked");const t={username:e.getUsername(),password:e.getPassword()},n=Rr(Vr,"/users"),i={};i[Ar(n).key]=t,Or(n,i),this.clearForm()}clearForm(){this.signUpform.reset()}},so("travel-forum"),po.forEach((e=>{e.addEventListener("click",(e=>{const t=e.target.id;so(t)}))})),go.addEventListener("click",(e=>{e.preventDefault(),yo();const t=Date.now(),n=new Date(t),i=e=>e<10?"0"+e:e,s=i(n.getDate())+"-"+i(n.getMonth()+1)+"-"+n.getFullYear()+", "+i(n.getHours())+":"+i(n.getMinutes());if(""==fo.value)alert("Enter text to post!");else{const e={message:fo.value,username:_o.innerText,timestamp:s,userId:_o.id};fo.value="";const t={};t[Ar(uo).key]=e,Or(uo,t)}}));
//# sourceMappingURL=index.20c0bba9.js.map
