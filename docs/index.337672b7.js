 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const Dr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"}));const Ar=document.querySelector("#travel-div"),Mr=document.querySelector("#sport-div"),Or=document.querySelector("#gaming-div"),Lr=br(Dr,"/messages"),Fr=br(Dr,"/users"),qr=document.querySelectorAll(".forum-btn");kr(Lr,(e=>{const t=e.val();console.log(t)})),kr(Fr,(e=>{const t=e.val();console.log(t)})),new class{constructor(){this.form=document.querySelector("#login-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),this.form.addEventListener("submit",this.validator.bind(this))}validator(e){e.preventDefault(),console.log("validator invoked"),this.username.value.length>4&&this.password.value.length}},qr.forEach((e=>{e.addEventListener("click",(e=>{console.log("forum button clicked");(e=>{"travel-forum"==e?(Ar.style.display="flex",Mr.style.display="none",Or.style.display="none"):"sport-forum"==e?(Ar.style.display="none",Mr.style.display="flex",Or.style.display="none"):"gaming-forum"==e&&(Ar.style.display="none",Mr.style.display="none",Or.style.display="flex")})(e.target.id)}))}));
//# sourceMappingURL=index.337672b7.js.map
