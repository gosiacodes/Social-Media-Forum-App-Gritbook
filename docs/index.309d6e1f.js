 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var de;de="",Z(new O("platform-logger",(e=>new Y(e)),"PRIVATE")),Z(new O("heartbeat",(e=>new le(e)),"PRIVATE")),ie("@firebase/app","0.7.20",de),ie("@firebase/app","0.7.20","esm2017"),ie("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Ln(i,new Et(t.toString()+"/"+e),n)}))}class On{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new On(e);const n=1e4+2e4*Math.random();it(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;Je(e,((e,i)=>{i>0&&b(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),it(this.reportStats_.bind(this),Math.floor(2*Math.random()*3e5))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ks{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qs(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Lt(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Xs(e,t,n){Qs(e,n),Zs(e,(e=>Lt(e,t)))}function Js(e,t,n){Qs(e,n),Zs(e,(e=>Ot(e,t)||Ot(t,e)))}function Zs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(er(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function er(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&je("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ne="9.6.10",Z(new O("database",((e,{instanceIdentifier:t})=>Hr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.7",e),ie("@firebase/database","0.12.7","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const zr=document.querySelector(".user"),Vr=document.querySelector("#message"),$r=e=>{e.preventDefault();const t=e.target.id;To(t)},Yr=e=>{!function(e){Ys("remove",e._path),Mr(e,null)}(Rr(Kr,"/messages/"+Co.id+"/"+e.id))};class Gr{constructor(e,t,n,i,s){this.id=e,this.username=t,this.message=n,this.timestamp=i,this.userId=s}clearChat(){document.querySelector(`#${this.id}`).remove()}displayChat(){So(this)}deleteMessage(){Yr(this)}editMessage(e){((e,t)=>{t.contentEditable="true",t.className="mess-edit",t.focus();const n=document.querySelector(".mess-edit");t.addEventListener("keydown",(i=>{if("Enter"===i.code){i.preventDefault(),t.contentEditable="false",e.message=n.innerText;const s=Rr(Kr,"/messages/"+Co.id+"/"+e.id),r={};r["/message"]=e.message,Fr(s,r),t.classList.remove("mess-edit")}else"Escape"===i.code&&(i.preventDefault(),t.contentEditable="false",t.classList.remove("mess-edit"),io())}))})(this,e)}}const Kr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"})),Qr=Rr(Kr,"/messages/travel"),Xr=Rr(Kr,"messages/sport"),Jr=Rr(Kr,"messages/gaming"),Zr=Rr(Kr,"/users");let eo,to=[];const no=()=>{!0===bo?eo=Qr:!0===Io?eo=Xr:!0===Eo&&(eo=Jr)},io=()=>{no(),Ur(eo,(e=>{const t=e.val();console.log(t);for(const e of to)e.clearChat();to=[];for(const e in t)to.push(new Gr(e,t[e].username,t[e].message,t[e].timestamp,t[e].userId));console.log(to);for(const e of to)e.displayChat()}))},so=()=>{let e;return Ur(Zr,(t=>{e=t.val(),console.log(e)})),e};so();const ro=document.querySelector("#travel"),oo=document.querySelector("#sport"),ao=document.querySelector("#gaming"),lo=document.querySelector("#travel-chat"),ho=document.querySelector("#sport-chat"),co=document.querySelector("#gaming-chat"),uo=document.querySelector("#travel-forum"),po=document.querySelector("#sport-forum"),_o=document.querySelector("#gaming-forum"),fo=document.querySelector(".user"),mo=document.querySelector(".show-user-profile"),go=document.querySelector("#user-profile-modal"),yo=document.querySelector("#profile-close-btn"),vo=document.querySelector("#user-close");let Co=ro,wo=lo,bo=!0,Io=!1,Eo=!1;const To=e=>{"travel-forum"==e?(Co=ro,wo=lo,ro.style.display="flex",oo.style.display="none",ao.style.display="none",uo.classList.add("active"),po.classList.remove("active"),_o.classList.remove("active"),bo=!0,Io=!1,Eo=!1,io()):"sport-forum"==e?(Co=oo,wo=ho,ro.style.display="none",oo.style.display="flex",ao.style.display="none",uo.classList.remove("active"),po.classList.add("active"),_o.classList.remove("active"),bo=!1,Io=!0,Eo=!1,io()):"gaming-forum"==e&&(Co=ao,wo=co,ro.style.display="none",oo.style.display="none",ao.style.display="flex",uo.classList.remove("active"),po.classList.remove("active"),_o.classList.add("active"),bo=!1,Io=!1,Eo=!0,io())},So=e=>{const t=document.createElement("div"),n=document.createElement("div"),i=document.createElement("h5"),s=document.createElement("h5"),r=document.createElement("p"),o=document.createElement("button"),a=document.createElement("div");i.innerText=e.username,i.className="mess-show-profile",i.id=e.userId,s.innerText=e.timestamp,r.innerText=e.message,o.innerText="X",o.className="delete-btn",t.className="user-div",n.className="mess-div",a.className="message-container",a.id=e.id,t.append(i),i.addEventListener("click",(e=>{e.preventDefault(),ko(e)})),t.append(s),n.append(r),e.username==fo.innerText&&e.userId==fo.id&&(n.append(o),o.addEventListener("click",(t=>{t.preventDefault(),e.deleteMessage()})),r.addEventListener("click",(t=>{t.preventDefault(),e.editMessage(r)}))),a.append(t),a.append(n),wo.prepend(a),Co.append(wo)},ko=e=>{e.preventDefault();const t=e.target,n=document.querySelector("#profil-username");let i;t===mo?(i=fo.id,mo.id=fo.id,n.innerText=fo.innerText):(i=t.id,n.innerText=t.innerText),console.log(i),go.style.display="block",yo.addEventListener("click",(()=>{go.style.display="none"})),vo.addEventListener("click",(()=>{go.style.display="none"})),window.onclick=function(e){e.target===go&&(go.style.display="none")}};class No{constructor(e,t,n,i){this.username=e,this.password=t,this.desc=n,this.imageUrl=i}getUsername(){return this.username}getPassword(){return this.password}getDesc(){return this.desc}getImage(){return this.imageUrl}}const Po=document.querySelectorAll(".forum-btn"),xo=document.querySelector("#add-message-btn"),Ro=document.querySelector(".show-user-profile");new class{constructor(e=document.querySelector("#login-form"),t=document.querySelector("#signup-form"),n=document.querySelector("#username"),i=document.querySelector("#password")){this.signInForm=e,this.signUpForm=t,this.username=n,this.password=i,document.querySelector("#signin-btn").addEventListener("click",this.validator.bind(this)),document.querySelector("#btn-signup-ui").addEventListener("click",this.hideUI.bind(this)),document.querySelector("#logout-btn").addEventListener("click",this.logout.bind(this))}login(e,t){const n=document.querySelector(".profile"),i=document.querySelector("#forums-section"),s=document.querySelector("#login-form"),r=document.querySelector("#logout-btn"),o=document.querySelector("#header-data");alert(`You are logged in, welcome ${e}!`);const a=document.querySelector(".user");a.textContent=e,a.setAttribute("id",t),this.clearForm(),To("travel-forum"),o.style.justifyContent="space-between",n.style.display="flex",i.style.display="flex",s.style.display="none",r.style.display="inline-block"}logout(e){e.preventDefault();const t=document.querySelector(".profile"),n=document.querySelector("#forums-section"),i=document.querySelector("#login-form"),s=document.querySelector("#logout-btn");document.querySelector("#header-data").style.justifyContent="center",t.style.display="none",n.style.display="none",i.style.display="flex",s.style.display="none";document.querySelector(".user").textContent=""}validator(e){if(e.preventDefault(),this.username.value.length>=4&&this.password.value.length>=4){const e=so();if(e){for(const t in e)if(this.username.value==e[t].username&&this.password.value==e[t].password)return void this.login(e[t].username,t);alert("Invalid username or password"),this.clearForm()}}else alert("Username and password must be at least 4 characters long"),this.clearForm()}hideUI(e){e.preventDefault(),this.clearForm(),this.signInForm.style.display="none",this.signUpForm.style.display="flex"}clearForm(){this.signInForm.reset()}},new class{constructor(e=document.querySelector("#new_username"),t=document.querySelector("#new_password"),n=document.querySelector("#repeat_password"),i=document.querySelector("#signup-form"),s=document.querySelector("#login-form"),r=document.querySelector("#profile-form"),o=document.querySelector("#profil-desc")){this.usernameInField=e,this.passwordInField=t,this.repeatPasswordInField=n,this.signUpform=i,this.signInForm=s,this.profileForm=r,this.profileDesc=o,document.querySelector("#signup-btn").addEventListener("click",this.validateForm.bind(this)),document.querySelector("#btn-display-signin").addEventListener("click",this.hideUI.bind(this)),document.querySelector("#update-btn").addEventListener("click",this.update.bind(this)),document.querySelector("#img-container").addEventListener("click",this.updateProfilePic.bind(this))}validateForm(e){e.preventDefault();const t=so();let n=[];for(const e in t)n.push(t[e].username);this.usernameInField.value.length<4||this.passwordInField.value.length<4||this.repeatPasswordInField.value.length<4?alert("username/password length is less than 4 characters"):n.includes(this.usernameInField.value)?alert("username already exists"):this.passwordInField.value==this.repeatPasswordInField.value?(this.signUpform.style.display="none",this.profileForm.style.display="flex"):alert("password does not match")}hideUI(e){e.preventDefault(),this.signUpform.style.display="none",this.signInForm.style.display="flex"}signupUser(e){const t={username:e.getUsername(),password:e.getPassword(),desc:e.getDesc(),image:e.getImage()},n=Rr(Kr,"/users"),i=Ar(n).key,s={};s[i]=t,Fr(n,s),this.login(e.getUsername(),i),this.clearForm(),alert("Welcome to Gritbook!"),this.profileForm.style.display="none"}login(e,t){const n=document.querySelector(".profile"),i=document.querySelector("#forums-section"),s=document.querySelector("#signup-form"),r=document.querySelector("#logout-btn"),o=document.querySelector("#header-data"),a=document.querySelector(".user");a.textContent=e,a.setAttribute("id",t),this.clearForm(),To("travel-forum"),o.style.justifyContent="space-between",n.style.display="flex",i.style.display="flex",s.style.display="none",r.style.display="inline-block"}update(e){e.preventDefault();const t=document.querySelector(".selected-profile-img").getAttribute("src").substring(22);this.signupUser(new No(this.usernameInField.value,this.passwordInField.value,this.profileDesc.value,t))}updateProfilePic(e){if(e.preventDefault(),void 0===e.target.src)return;document.querySelector(".selected-profile-img").setAttribute("src",e.target.src)}clearForm(){this.signUpform.reset()}},Po.forEach((e=>{e.addEventListener("click",$r)})),xo.addEventListener("click",(e=>{e.preventDefault(),no();const t=Date.now(),n=new Date(t),i=e=>e<10?"0"+e:e,s=i(n.getDate())+"-"+i(n.getMonth()+1)+"-"+n.getFullYear()+", "+i(n.getHours())+":"+i(n.getMinutes());if(""==Vr.value)alert("Enter text to post!");else{const e={message:Vr.value,username:zr.innerText,timestamp:s,userId:zr.id},t={};t[Ar(eo).key]=e,Fr(eo,t),Vr.value=""}})),Ro.addEventListener("click",ko);
//# sourceMappingURL=index.309d6e1f.js.map
