 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");class zr{constructor(e,t,n,i,s){this.id=e,this.username=t,this.message=n,this.timestamp=i,this.userId=s}clearChat(){document.querySelector(`#${this.id}`).remove()}displayChat(){_o(this)}}const Vr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"})),$r=Rr(Vr,"/messages/travel"),Yr=Rr(Vr,"messages/sport"),Gr=Rr(Vr,"messages/gaming"),Kr=Rr(Vr,"/users");let Qr,Xr=[];const Jr=()=>{!0===ho?Qr=$r:!0===co?Qr=Yr:!0===uo&&(Qr=Gr)},Zr=()=>{Jr(),Ur(Qr,(e=>{const t=e.val();console.log(t);for(const e of Xr)e.clearChat();Xr=[];for(const e in t)Xr.push(new zr(e,t[e].username,t[e].message,t[e].timestamp,t[e].userId));console.log(Xr);for(const e of Xr)e.displayChat()}))},eo=()=>{let e;return Ur(Kr,(t=>{e=t.val(),console.log(e)})),e};eo();const to=document.querySelector("#travel"),no=document.querySelector("#sport"),io=document.querySelector("#gaming"),so=document.querySelector("#travel-chat"),ro=document.querySelector("#sport-chat"),oo=document.querySelector("#gaming-chat");let ao=to,lo=so,ho=!0,co=!1,uo=!1;const po=e=>{"travel-forum"==e?(ao=to,lo=so,to.style.display="flex",no.style.display="none",io.style.display="none",ho=!0,co=!1,uo=!1,Zr()):"sport-forum"==e?(ao=no,lo=ro,to.style.display="none",no.style.display="flex",io.style.display="none",ho=!1,co=!0,uo=!1,Zr()):"gaming-forum"==e&&(ao=io,lo=oo,to.style.display="none",no.style.display="none",io.style.display="flex",ho=!1,co=!1,uo=!0,Zr())},_o=e=>{const t=document.querySelector(".user"),n=document.createElement("div"),i=document.createElement("div"),s=document.createElement("h5"),r=document.createElement("h5"),o=document.createElement("p"),a=document.createElement("button"),l=document.createElement("div");s.innerText=e.username,r.innerText=e.timestamp,o.innerText=e.message,a.innerText="X",a.className="delete-btn",n.className="user-div",i.className="mess-div",l.className="message-container",l.id=e.id,n.append(s),n.append(r),i.append(o),e.username==t.innerText&&e.userId==t.id&&(i.append(a),a.addEventListener("click",(()=>{!function(e){Ys("remove",e._path),Mr(e,null)}(Rr(Vr,"/messages/"+ao.id+"/"+e.id))}))),l.append(n),l.append(i),lo.prepend(l),ao.append(lo)};class fo{constructor(e,t){this.username=e,this.password=t}getUsername(){return this.username}getPassword(){return this.password}}const go=document.querySelector(".user"),mo=document.querySelector("#message"),yo=e=>{e.preventDefault();const t=e.target.id;po(t)},vo=document.querySelectorAll(".forum-btn"),Co=document.querySelector("#add-message-btn");new class{constructor(){this.signInForm=document.querySelector("#login-form"),this.signUpForm=document.querySelector("#signup-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),document.querySelector("#signin-btn").addEventListener("click",this.validator.bind(this)),document.querySelector("#btn-signup-ui").addEventListener("click",this.hideUI.bind(this))}validator(e){if(e.preventDefault(),console.log("validator invoked"),console.log(this.username.value),console.log(this.password.value),this.username.value.length>=4&&this.password.value.length>=4){const e=eo();if(e){for(const t in e)if(this.username.value==e[t].username&&this.password.value==e[t].password){console.log("login success");const n=document.querySelector(".user");return n.textContent=e[t].username,n.setAttribute("id",t),this.clearForm(),void po("travel-forum")}console.log("login failed"),this.clearForm()}}else console.log("username/password length is less than 4 characters"),this.clearForm()}hideUI(e){e.preventDefault(),this.clearForm(),this.signInForm.style.display="none",this.signUpForm.style.display="flex"}clearForm(){this.signInForm.reset()}},new class{constructor(){this.usernameInField=document.querySelector("#new_username"),this.passwordInField=document.querySelector("#new_password"),this.repeatPasswordInField=document.querySelector("#repeat_password"),this.signUpform=document.querySelector("#signup-form"),this.signInForm=document.querySelector("#login-form"),document.querySelector("#signup-btn").addEventListener("click",this.validateForm.bind(this)),document.querySelector("#btn-display-signin").addEventListener("click",this.hideUI.bind(this))}validateForm(e){e.preventDefault();const t=eo();let n=[];for(const e in t)n.push(t[e].username);this.usernameInField.value.length<4||this.passwordInField.value.length<4||this.repeatPasswordInField.value.length<4?alert("username/password length is less than 4 characters"):n.includes(this.usernameInField.value)?alert("username already exists"):this.passwordInField.value==this.repeatPasswordInField.value?(alert("signup success"),this.initNewUser(new fo(this.usernameInField.value,this.passwordInField.value))):alert("password does not match")}hideUI(e){e.preventDefault(),console.log("hideUI invoked"),this.signUpform.style.display="none",this.signInForm.style.display="flex"}initNewUser(e){console.log("initNewUser invoked");const t={username:e.getUsername(),password:e.getPassword()},n=Rr(Vr,"/users"),i={};i[Ar(n).key]=t,Fr(n,i),this.clearForm()}clearForm(){this.signUpform.reset()}},po("travel-forum"),vo.forEach((e=>{e.addEventListener("click",yo)})),Co.addEventListener("click",(e=>{e.preventDefault(),Jr();const t=Date.now(),n=new Date(t),i=e=>e<10?"0"+e:e,s=i(n.getDate())+"-"+i(n.getMonth()+1)+"-"+n.getFullYear()+", "+i(n.getHours())+":"+i(n.getMinutes());if(""==mo.value)alert("Enter text to post!");else{const e={message:mo.value,username:go.innerText,timestamp:s,userId:go.id},t={};t[Ar(Qr).key]=e,Fr(Qr,t),mo.value=""}}));
//# sourceMappingURL=index.543b44e8.js.map
