 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var de;de="",Z(new L("platform-logger",(e=>new Y(e)),"PRIVATE")),Z(new L("heartbeat",(e=>new le(e)),"PRIVATE")),ie("@firebase/app","0.7.20",de),ie("@firebase/app","0.7.20","esm2017"),ie("fire-js","");var pe,_e,fe,ge=pe={};function me(){throw new Error("setTimeout has not been defined")}function ye(){throw new Error("clearTimeout has not been defined")}function ve(e){if(_e===setTimeout)return setTimeout(e,0);if((_e===me||!_e)&&setTimeout)return _e=setTimeout,setTimeout(e,0);try{return _e(e,0)}catch(t){try{return _e.call(null,e,0)}catch(t){return _e.call(this,e,0)}}}!function(){try{_e="function"==typeof setTimeout?setTimeout:me}catch(e){_e=me}try{fe="function"==typeof clearTimeout?clearTimeout:ye}catch(e){fe=ye}}();var Ce,we=[],be=!1,Ie=-1;function Te(){be&&Ce&&(be=!1,Ce.length?we=Ce.concat(we):Ie=-1,we.length&&Ee())}function Ee(){if(!be){var e=ve(Te);be=!0;for(var t=we.length;t;){for(Ce=we,we=[];++Ie<t;)Ce&&Ce[Ie].run();Ie=-1,t=we.length}Ce=null,be=!1,function(e){if(fe===clearTimeout)return clearTimeout(e);if((fe===ye||!fe)&&clearTimeout)return fe=clearTimeout,clearTimeout(e);try{fe(e)}catch(t){try{return fe.call(null,e)}catch(t){return fe.call(this,e)}}}(e)}}function Se(e,t){this.fun=e,this.array=t}function ke(){}ge.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var n=1;n<arguments.length;n++)t[n-1]=arguments[n];we.push(new Se(e,t)),1!==we.length||be||ve(Ee)},Se.prototype.run=function(){this.fun.apply(null,this.array)},ge.title="browser",ge.browser=!0,ge.env={},ge.argv=[],ge.version="",ge.versions={},ge.on=ke,ge.addListener=ke,ge.once=ke,ge.off=ke,ge.removeListener=ke,ge.removeAllListeners=ke,ge.emit=ke,ge.prependListener=ke,ge.prependOnceListener=ke,ge.listeners=function(e){return[]},ge.binding=function(e){throw new Error("process.binding is not supported")},ge.cwd=function(){return"/"},ge.chdir=function(e){throw new Error("process.chdir is not supported")},ge.umask=function(){return 0};
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
function bn(e){return{type:"value",snapshotNode:e}}function In(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function Tn(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function En(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Sn{constructor(e){this.index_=e}updateChild(e,t,n,s,r,o){i(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(n.getChild(s))&&a.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(Tn(t,a)):i(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(In(t,n)):o.trackChildChange(En(t,n,a))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(an,((e,i)=>{t.hasChild(e)||n.trackChildChange(Tn(e,i))})),t.isLeafNode()||t.forEachChild(an,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(En(t,i,s))}else n.trackChildChange(In(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?fn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dn extends wt{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=je("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:(i(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const s=e._path.toString();this.log_("Listen called for "+s+" "+e._queryIdentifier);const r=Dn.getListenId_(e,n),o={};this.listens_[r]=o;const a=xn(e._queryParams);this.restRequest_(s+".json",a,((e,t)=>{let a=t;if(404===e&&(a=null,e=null),null===e&&this.onDataUpdate_(s,a,!1,n),I(this.listens_,r)===o){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=Dn.getListenId_(e,t);delete this.listens_[n]}get(e){const t=xn(e._queryParams),n=e._path.toString(),i=new d;return this.restRequest_(n+".json",t,((e,t)=>{let s=t;404===e&&(s=null,e=null),null===e?(this.onDataUpdate_(n,s,!1,null),i.resolve(s)):i.reject(new Error(s))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,s])=>{i&&i.accessToken&&(t.auth=i.accessToken),s&&s.token&&(t.ac=s.token);const r=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+function(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}(t);this.log_("Sending REST request for "+r);const o=new XMLHttpRequest;o.onreadystatechange=()=>{if(n&&4===o.readyState){this.log_("REST Response for "+r+" received. status:",o.status,"response:",o.responseText);let e=null;if(o.status>=200&&o.status<300){try{e=v(o.responseText)}catch(e){Ve("Failed to parse JSON response for "+r+": "+o.responseText)}n(null,e)}else 401!==o.status&&404!==o.status&&Ve("Got unsuccessful REST response for "+r+" Status: "+o.status),n(o.status);n=null}},o.open("GET",r,!0),o.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,((e,i)=>{Fn(i,new Tt(t.toString()+"/"+e),n)}))}class Ln{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&Je(this.last_,((e,n)=>{t[e]=t[e]-n})),this.last_=e,t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Un,Wn;function Hn(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Wn=Un||(Un={}))[Wn.OVERWRITE=0]="OVERWRITE",Wn[Wn.MERGE=1]="MERGE",Wn[Wn.ACK_USER_WRITE=2]="ACK_USER_WRITE",Wn[Wn.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class jn{constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=Un.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}operationForChild(e){if(At(this.path)){if(null!=this.affectedTree.value)return i(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Tt(e));return new jn(Et(),t,this.revert)}}return i(St(this.path)===e,"operationForChild called for unrelated child."),new jn(Nt(this.path),this.affectedTree,this.revert)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,t){this.source=e,this.path=t,this.type=Un.LISTEN_COMPLETE}operationForChild(e){return At(this.path)?new Bn(this.source,Et()):new Bn(this.source,Nt(this.path))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Un.OVERWRITE}operationForChild(e){return At(this.path)?new zn(this.source,Et(),this.snap.getImmediateChild(e)):new zn(this.source,Nt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Un.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new Tt(e));return t.isEmpty()?null:t.value?new zn(this.source,Et(),t.value):new Vn(this.source,Et(),t)}return i(St(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Vn(this.source,Nt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Pi{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new $n(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ti(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Zn(this.viewCache_),s=Ii(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ks{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Qs(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ft(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Xs(e,t,n){Qs(e,n),Zs(e,(e=>Ft(e,t)))}function Js(e,t,n){Qs(e,n),Zs(e,(e=>Lt(e,t)||Lt(t,e)))}function Zs(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(er(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function er(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&He("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const Br=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"}));const zr=document.querySelector("#travel-div"),Vr=document.querySelector("#sport-div"),$r=document.querySelector("#gaming-div");let Yr=!0,Gr=!1,Kr=!1;const Qr=Rr(Br,"/messages/travel"),Xr=Rr(Br,"messages/sport"),Jr=Rr(Br,"messages/gaming"),Zr=Rr(Br,"/users"),eo=document.querySelectorAll(".forum-btn"),to=document.querySelector("#user"),no=document.querySelector("#message"),io=document.querySelector("#add-message-btn");qr(Qr,(e=>{const t=e.val();console.log(t)})),qr(Xr,(e=>{const t=e.val();console.log(t)})),qr(Jr,(e=>{const t=e.val();console.log(t)}));qr(Zr,(e=>{const t=e.val();console.log(t)})),new class{constructor(){this.signInForm=document.querySelector("#login-form"),this.signUpForm=document.querySelector("#signup-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),document.querySelector("#signin-btn").addEventListener("submit",this.validator.bind(this)),document.querySelector("#btn-signup-ui").addEventListener("click",this.hideUI.bind(this))}validator(e){e.preventDefault(),console.log("validator invoked")}hideUI(e){e.preventDefault(),console.log("hideUI invoked"),this.signInForm.style.display="none",this.signUpForm.style.display="block"}},new class{constructor(){this.usernameInField=document.querySelector("#new_username"),this.passwordInField=document.querySelector("#new_password"),this.repeatPasswordInField=document.querySelector("#repeat_password"),this.signUpform=document.querySelector("#signup-form"),this.signInForm=document.querySelector("#login-form"),document.querySelector("#signup-btn").addEventListener("submit",this.validateSignForm.bind(this)),document.querySelector("#btn-display-signin").addEventListener("click",this.hideUI.bind(this))}validateSignForm(e){e.preventDefault(),console.log("validateSignForm invoked")}hideUI(e){e.preventDefault(),console.log("hideUI invoked"),this.signUpform.style.display="none",this.signInForm.style.display="block"}},eo.forEach((e=>{e.addEventListener("click",(e=>{(e=>{"travel-forum"==e?(zr.style.display="flex",Vr.style.display="none",$r.style.display="none",Yr=!0,Gr=!1,Kr=!1):"sport-forum"==e?(zr.style.display="none",Vr.style.display="flex",$r.style.display="none",Yr=!1,Gr=!0,Kr=!1):"gaming-forum"==e&&(zr.style.display="none",Vr.style.display="none",$r.style.display="flex",Yr=!1,Gr=!1,Kr=!0)})(e.target.id)}))})),io.addEventListener("click",(e=>{let t;e.preventDefault(),console.log(Yr),!0===Yr?t=Qr:!0===Gr?t=Xr:!0===Kr&&(t=Jr);const n=Date.now(),i=new Date(n),s=e=>e<10?"0"+e:e,r=s(i.getDate())+"-"+s(i.getMonth()+1)+"-"+i.getFullYear()+", "+s(i.getHours())+":"+s(i.getMinutes()),o={message:no.value,username:to.innerText,timestamp:r};no.value="";const a={};a[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Ar(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(t).key]=o,Mr(t,a)}));
//# sourceMappingURL=index.e68745bf.js.map
