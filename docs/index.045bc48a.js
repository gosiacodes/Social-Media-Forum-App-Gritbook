 ...
 * limitations under the License.
 */
const Wr={};let Hr=!1;function jr(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,l=Ir(r,s),h=l.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${h.namespace}`,l=Ir(r,s),h=l.repoInfo):o=!l.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Gs("Invalid Firebase Database URL",l),At(l.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Wr[t.name];s||(s={},Wr[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new tr(e,Hr,n,i),s[e.toURLString()]=r,r}(h,e,c,new st(e.name,n));return new Br(u,e)}class Br{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nr(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Pr(this._repo,Tt())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Wr[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ur(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}jt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},jt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ne="9.6.10",Z(new L("database",((e,{instanceIdentifier:t})=>jr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.7",e),ie("@firebase/database","0.12.7","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const zr=document.querySelector(".user"),Vr=document.querySelector("#message"),$r=e=>{e.preventDefault();const t=e.target.id;mo(t)},Yr=e=>{!function(e){Ys("remove",e._path),Mr(e,null)}(Rr(Kr,"/messages/"+uo.id+"/"+e.id))};class Gr{constructor(e,t,n,i,s){this.id=e,this.username=t,this.message=n,this.timestamp=i,this.userId=s}clearChat(){document.querySelector(`#${this.id}`).remove()}displayChat(){yo(this)}deleteMessage(){Yr(this)}editMessage(e){((e,t)=>{t.contentEditable="true",t.className="mess-edit",t.focus();const n=document.querySelector(".mess-edit");t.addEventListener("keydown",(i=>{if("Enter"===i.code){i.preventDefault(),t.contentEditable="false",e.message=n.innerText;const s=Rr(Kr,"/messages/"+uo.id+"/"+e.id),r={};r["/message"]=e.message,Fr(s,r),t.classList.remove("mess-edit")}else"Escape"===i.code&&(i.preventDefault(),t.contentEditable="false",t.classList.remove("mess-edit"),io())}))})(this,e)}}const Kr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"})),Qr=Rr(Kr,"/messages/travel"),Xr=Rr(Kr,"messages/sport"),Jr=Rr(Kr,"messages/gaming"),Zr=Rr(Kr,"/users");let eo,to=[];const no=()=>{!0===_o?eo=Qr:!0===fo?eo=Xr:!0===go&&(eo=Jr)},io=()=>{no(),Ur(eo,(e=>{const t=e.val();console.log(t);for(const e of to)e.clearChat();to=[];for(const e in t)to.push(new Gr(e,t[e].username,t[e].message,t[e].timestamp,t[e].userId));console.log(to);for(const e of to)e.displayChat()}))},so=()=>{let e;return Ur(Zr,(t=>{e=t.val(),console.log(e)})),e};so();const ro=document.querySelector("#travel"),oo=document.querySelector("#sport"),ao=document.querySelector("#gaming"),lo=document.querySelector("#travel-chat"),ho=document.querySelector("#sport-chat"),co=document.querySelector("#gaming-chat");let uo=ro,po=lo,_o=!0,fo=!1,go=!1;const mo=e=>{"travel-forum"==e?(uo=ro,po=lo,ro.style.display="flex",oo.style.display="none",ao.style.display="none",_o=!0,fo=!1,go=!1,io()):"sport-forum"==e?(uo=oo,po=ho,ro.style.display="none",oo.style.display="flex",ao.style.display="none",_o=!1,fo=!0,go=!1,io()):"gaming-forum"==e&&(uo=ao,po=co,ro.style.display="none",oo.style.display="none",ao.style.display="flex",_o=!1,fo=!1,go=!0,io())},yo=e=>{const t=document.querySelector(".user"),n=document.createElement("div"),i=document.createElement("div"),s=document.createElement("h5"),r=document.createElement("h5"),o=document.createElement("p"),a=document.createElement("button"),l=document.createElement("div");s.innerText=e.username,r.innerText=e.timestamp,o.innerText=e.message,a.innerText="X",a.className="delete-btn",n.className="user-div",i.className="mess-div",l.className="message-container",l.id=e.id,n.append(s),n.append(r),i.append(o),e.username==t.innerText&&e.userId==t.id&&(i.append(a),a.addEventListener("click",(t=>{t.preventDefault(),e.deleteMessage()})),o.addEventListener("click",(t=>{t.preventDefault(),e.editMessage(o)}))),l.append(n),l.append(i),po.prepend(l),uo.append(po)};class vo{constructor(e,t){this.username=e,this.password=t}getUsername(){return this.username}getPassword(){return this.password}}const Co=document.querySelectorAll(".forum-btn"),wo=document.querySelector("#add-message-btn");new class{constructor(){this.signInForm=document.querySelector("#login-form"),this.signUpForm=document.querySelector("#signup-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),document.querySelector("#signin-btn").addEventListener("click",this.validator.bind(this)),document.querySelector("#btn-signup-ui").addEventListener("click",this.hideUI.bind(this)),document.querySelector("#logout-btn").addEventListener("click",this.logout.bind(this))}login(e,t){document.querySelector(".profile");const n=document.querySelector("#forums-section"),i=document.querySelector("#login-form"),s=document.querySelector("#logout-btn");console.log("login success");const r=document.querySelector(".user");r.textContent=e,r.setAttribute("id",t),this.clearForm(),mo("travel-forum"),n.style.display="flex",i.style.display="none",s.style.display="inline-block"}logout(e){e.preventDefault(),console.log("logout");const t=document.querySelector(".profile"),n=document.querySelector("#forums-section"),i=document.querySelector("#login-form");t.style.display="flex",n.style.display="none",i.style.display="flex";document.querySelector(".user").textContent=""}validator(e){if(e.preventDefault(),console.log("validator invoked"),console.log(this.username.value),console.log(this.password.value),this.username.value.length>=4&&this.password.value.length>=4){const e=so();if(e){for(const t in e)if(this.username.value==e[t].username&&this.password.value==e[t].password)return void this.login(e[t].username,t);console.log("login failed"),this.clearForm()}}else console.log("username/password length is less than 4 characters"),this.clearForm()}hideUI(e){e.preventDefault(),this.clearForm(),this.signInForm.style.display="none",this.signUpForm.style.display="flex"}clearForm(){this.signInForm.reset()}},new class{constructor(){this.usernameInField=document.querySelector("#new_username"),this.passwordInField=document.querySelector("#new_password"),this.repeatPasswordInField=document.querySelector("#repeat_password"),this.signUpform=document.querySelector("#signup-form"),this.signInForm=document.querySelector("#login-form"),document.querySelector("#signup-btn").addEventListener("click",this.validateForm.bind(this)),document.querySelector("#btn-display-signin").addEventListener("click",this.hideUI.bind(this))}validateForm(e){e.preventDefault();const t=so();let n=[];for(const e in t)n.push(t[e].username);this.usernameInField.value.length<4||this.passwordInField.value.length<4||this.repeatPasswordInField.value.length<4?alert("username/password length is less than 4 characters"):n.includes(this.usernameInField.value)?alert("username already exists"):this.passwordInField.value==this.repeatPasswordInField.value?(alert("signup success"),this.initNewUser(new vo(this.usernameInField.value,this.passwordInField.value))):alert("password does not match")}hideUI(e){e.preventDefault(),console.log("hideUI invoked"),this.signUpform.style.display="none",this.signInForm.style.display="flex"}initNewUser(e){console.log("initNewUser invoked");const t={username:e.getUsername(),password:e.getPassword()},n=Rr(Kr,"/users"),i={};i[Ar(n).key]=t,Fr(n,i),this.clearForm()}clearForm(){this.signUpform.reset()}},mo("travel-forum"),Co.forEach((e=>{e.addEventListener("click",$r)})),wo.addEventListener("click",(e=>{e.preventDefault(),no();const t=Date.now(),n=new Date(t),i=e=>e<10?"0"+e:e,s=i(n.getDate())+"-"+i(n.getMonth()+1)+"-"+n.getFullYear()+", "+i(n.getHours())+":"+i(n.getMinutes());if(""==Vr.value)alert("Enter text to post!");else{const e={message:Vr.value,username:zr.innerText,timestamp:s,userId:zr.id},t={};t[Ar(eo).key]=e,Fr(eo,t),Vr.value=""}}));
//# sourceMappingURL=index.045bc48a.js.map
