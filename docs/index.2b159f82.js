 ...
 * limitations under the License.
 */
class Sn{constructor(e){this.index_=e}updateChild(e,t,n,s,r,o){i(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(s).equals(n.getChild(s))&&a.isEmpty()===n.isEmpty()?e:(null!=o&&(n.isEmpty()?e.hasChild(t)?o.trackChildChange(En(t,a)):i(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Tn(t,n)):o.trackChildChange(In(t,n,a))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(an,((e,i)=>{t.hasChild(e)||n.trackChildChange(En(e,i))})),t.isLeafNode()||t.forEachChild(an,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(In(t,i,s))}else n.trackChildChange(Tn(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?fn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class Pi{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new $n(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Ei(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Zn(this.viewCache_),s=Ti(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const Br=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"}));const zr=document.querySelector("#travel-div"),Vr=document.querySelector("#sport-div"),$r=document.querySelector("#gaming-div");let Yr=!0,Gr=!1,Kr=!1;const Qr=Rr(Br,"/messages/travel"),Xr=Rr(Br,"messages/sport"),Jr=Rr(Br,"messages/gaming"),Zr=Rr(Br,"/users"),eo=document.querySelectorAll(".forum-btn"),to=document.querySelector("#user"),no=document.querySelector("#message"),io=document.querySelector("#add-message-btn");qr(Qr,(e=>{const t=e.val();console.log(t)})),qr(Xr,(e=>{const t=e.val();console.log(t)})),qr(Jr,(e=>{const t=e.val();console.log(t)}));qr(Zr,(e=>{const t=e.val();console.log(t)})),new class{constructor(){this.form=document.querySelector("#login-form"),this.username=document.querySelector("#username"),this.password=document.querySelector("#password"),this.form.addEventListener("submit",this.validator.bind(this))}validator(e){e.preventDefault(),console.log("validator invoked"),this.username.value.length>4&&this.password.value.length}},eo.forEach((e=>{e.addEventListener("click",(e=>{(e=>{"travel-forum"==e?(zr.style.display="flex",Vr.style.display="none",$r.style.display="none",Yr=!0,Gr=!1,Kr=!1):"sport-forum"==e?(zr.style.display="none",Vr.style.display="flex",$r.style.display="none",Yr=!1,Gr=!0,Kr=!1):"gaming-forum"==e&&(zr.style.display="none",Vr.style.display="none",$r.style.display="flex",Yr=!1,Gr=!1,Kr=!0)})(e.target.id)}))})),io.addEventListener("click",(e=>{let t;e.preventDefault(),console.log(Yr),!0===Yr?t=Qr:!0===Gr?t=Xr:!0===Kr&&(t=Jr);const n={message:no.value,username:to.innerText};no.value="";const i={};i[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Ar(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}(t).key]=n,Mr(t,i)}));
//# sourceMappingURL=index.2b159f82.js.map
