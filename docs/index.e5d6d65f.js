 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bn{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Fn.MERGE}operationForChild(e){if(At(this.path)){const t=this.children.subtree(new It(e));return t.isEmpty()?null:t.value?new jn(this.source,Et(),t.value):new Bn(this.source,Et(),t)}return i(kt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Bn(this.source,Nt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class js{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Bs(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ot(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function zs(e,t,n){Bs(e,n),$s(e,(e=>Ot(e,t)))}function Vs(e,t,n){Bs(e,n),$s(e,(e=>Lt(e,t)||Lt(t,e)))}function $s(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){t(s.path)?(Ys(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Ys(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();qe&&He("event: "+n.toString()),nt(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs{constructor(e,t,n,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=n,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new js,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Dn(),this.transactionQueueTree_=new ks,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function Ks(e,t,n){if(e.stats_=pt(e.repoInfo_),e.forceRestClient_||("object"==typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i)>=0)e.server_=new xn(e.repoInfo_,((t,n,i,s)=>{Js(e,t,n,i,s)}),e.authTokenProvider_,e.appCheckProvider_),setTimeout((()=>Zs(e,!0)),0);else{if(null!=n){if("object"!=typeof n)throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{C(n)}catch(e){throw new Error("Invalid authOverride provided: "+e)}}e.persistentConnection_=new Ht(e.repoInfo_,t,((t,n,i,s)=>{Js(e,t,n,i,s)}),(t=>{Zs(e,t)}),(t=>{!function(e,t){Je(t,((t,n)=>{er(e,t,n)}))}(e,t)}),e.authTokenProvider_,e.appCheckProvider_,n),e.server_=e.persistentConnection_}e.authTokenProvider_.addTokenChangeListener((t=>{e.server_.refreshAuthToken(t)})),e.appCheckProvider_.addTokenChangeListener((t=>{e.server_.refreshAppCheckToken(t.token)})),e.statsReporter_=function(e,t){const n=e.toString();return dt[n]||(dt[n]=t()),dt[n]}(e.repoInfo_,(()=>new Ln(e.stats_,e.server_))),e.infoData_=new Rn,e.infoSyncTree_=new ts({startListening:(t,n,i,s)=>{let r=[];const o=e.infoData_.getNode(t._path);return o.isEmpty()||(r=ss(e.infoSyncTree_,t._path,o),setTimeout((()=>{s("ok")}),0)),r},stopListening:()=>{}}),er(e,"connected",!1),e.serverSyncTree_=new ts({startListening:(t,n,i,s)=>(e.server_.listen(t,i,n,((n,i)=>{const r=s(n,i);Vs(e.eventQueue_,t._path,r)})),[]),stopListening:(t,n)=>{e.server_.unlisten(t,n)}})}function Qs(e){const t=e.infoData_.getNode(new It(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+t}function Xs(e){return(t=(t={timestamp:Qs(e)})||{}).timestamp=t.timestamp||(new Date).getTime(),t;var t}function Js(e,t,n,i,s){e.dataUpdateCount++;const r=new It(t);n=e.interceptServerDataCallback_?e.interceptServerDataCallback_(t,n):n;let o=[];if(s)if(i){const t=E(n,(e=>gn(e)));o=function(e,t,n,i){const s=_s(e,i);if(s){const i=fs(s),r=i.path,o=i.queryId,a=Mt(r,t),h=Zn.fromObject(n);return gs(e,r,new Bn(Un(o),a,h))}return[]}(e.serverSyncTree_,r,t,s)}else{const t=gn(n);o=function(e,t,n,i){const s=_s(e,i);if(null!=s){const i=fs(s),r=i.path,o=i.queryId,a=Mt(r,t);return gs(e,r,new jn(Un(o),a,n))}return[]}(e.serverSyncTree_,r,t,s)}else if(i){const t=E(n,(e=>gn(e)));o=function(e,t,n){const i=Zn.fromObject(n);return hs(e,new Bn({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,i))}(e.serverSyncTree_,r,t)}else{const t=gn(n);o=ss(e.serverSyncTree_,r,t)}let a=r;o.length>0&&(a=ar(e,r)),Vs(e.eventQueue_,a,o)}function Zs(e,t){er(e,"connected",t),!1===t&&function(e){sr(e,"onDisconnectEvents");const t=Xs(e),n=Dn();Mn(e.onDisconnect_,Et(),((i,s)=>{const r=Ts(i,s,e.serverSyncTree_,t);An(n,i,r)}));let i=[];Mn(n,Et(),((t,n)=>{i=i.concat(ss(e.serverSyncTree_,t,n));const s=dr(e,t);ar(e,s)})),e.onDisconnect_=Dn(),Vs(e.eventQueue_,Et(),i)}(e)}function er(e,t,n){const i=new It("/.info/"+t),s=gn(n);e.infoData_.updateSnapshot(i,s);const r=ss(e.infoSyncTree_,i,s);Vs(e.eventQueue_,i,r)}function tr(e){return e.nextWriteId_++}function nr(e,t,n){let i;i=".info"===kt(t._path)?rs(e.infoSyncTree_,t,n):rs(e.serverSyncTree_,t,n),zs(e.eventQueue_,t._path,i)}function ir(e){e.persistentConnection_&&e.persistentConnection_.interrupt("repo_interrupt")}function sr(e,...t){let n="";e.persistentConnection_&&(n=e.persistentConnection_.id+":"),He(n,...t)}function rr(e,t,n){return as(e.serverSyncTree_,t,n)||_n.EMPTY_NODE}function or(e,t=e.transactionQueueTree_){if(t||ur(e,t),Ns(t)){const n=lr(e,t);i(n.length>0,"Sending zero length transaction queue");n.every((e=>0===e.status))&&function(e,t,n){const s=n.map((e=>e.currentWriteId)),r=rr(e,t,s);let o=r;const a=r.hash();for(let e=0;e<n.length;e++){const s=n[e];i(0===s.status,"tryToSendTransactionQueue_: items in queue should all be run."),s.status=1,s.retryCount++;const r=Mt(t,s.path);o=o.updateChild(r,s.currentOutputSnapshotRaw)}const h=o.val(!0),l=t;e.server_.put(l.toString(),h,(i=>{sr(e,"transaction put response",{path:l.toString(),status:i});let s=[];if("ok"===i){const i=[];for(let t=0;t<n.length;t++)n[t].status=2,s=s.concat(is(e.serverSyncTree_,n[t].currentWriteId)),n[t].onComplete&&i.push((()=>n[t].onComplete(null,!0,n[t].currentOutputSnapshotResolved))),n[t].unwatcher();ur(e,Ss(e.transactionQueueTree_,t)),or(e,e.transactionQueueTree_),Vs(e.eventQueue_,t,s);for(let e=0;e<i.length;e++)nt(i[e])}else{if("datastale"===i)for(let e=0;e<n.length;e++)3===n[e].status?n[e].status=4:n[e].status=0;else{Ve("transaction at "+l.toString()+" failed: "+i);for(let e=0;e<n.length;e++)n[e].status=4,n[e].abortReason=i}ar(e,t)}}),a)}(e,As(t),n)}else xs(t)&&Rs(t,(t=>{or(e,t)}))}function ar(e,t){const n=hr(e,t),s=As(n);return function(e,t,n){if(0===t.length)return;const s=[];let r=[];const o=t.filter((e=>0===e.status)).map((e=>e.currentWriteId));for(let h=0;h<t.length;h++){const l=t[h],c=Mt(n,l.path);let u,d=!1;if(i(null!==c,"rerunTransactionsUnderNode_: relativePath should not be null."),4===l.status)d=!0,u=l.abortReason,r=r.concat(is(e.serverSyncTree_,l.currentWriteId,!0));else if(0===l.status)if(l.retryCount>=25)d=!0,u="maxretry",r=r.concat(is(e.serverSyncTree_,l.currentWriteId,!0));else{const n=rr(e,l.path,o);l.currentInputSnapshot=n;const i=t[h].update(n.val());if(void 0!==i){Us("transaction failed: Data returned ",i,l.path);let t=gn(i);"object"==typeof i&&null!=i&&b(i,".priority")||(t=t.updatePriority(n.getPriority()));const s=l.currentWriteId,a=Xs(e),h=Is(t,n,a);l.currentOutputSnapshotRaw=t,l.currentOutputSnapshotResolved=h,l.currentWriteId=tr(e),o.splice(o.indexOf(s),1),r=r.concat(ns(e.serverSyncTree_,l.path,h,l.currentWriteId,l.applyLocally)),r=r.concat(is(e.serverSyncTree_,s,!0))}else d=!0,u="nodata",r=r.concat(is(e.serverSyncTree_,l.currentWriteId,!0))}Vs(e.eventQueue_,n,r),r=[],d&&(t[h].status=2,a=t[h].unwatcher,setTimeout(a,Math.floor(0)),t[h].onComplete&&("nodata"===u?s.push((()=>t[h].onComplete(null,!1,t[h].currentInputSnapshot))):s.push((()=>t[h].onComplete(new Error(u),!1,null)))))}var a;ur(e,e.transactionQueueTree_);for(let e=0;e<s.length;e++)nt(s[e]);or(e,e.transactionQueueTree_)}(e,lr(e,n),s),s}function hr(e,t){let n,i=e.transactionQueueTree_;for(n=kt(t);null!==n&&void 0===Ns(i);)i=Ss(i,n),n=kt(t=Nt(t));return i}function lr(e,t){const n=[];return cr(e,t,n),n.sort(((e,t)=>e.order-t.order)),n}function cr(e,t,n){const i=Ns(t);if(i)for(let e=0;e<i.length;e++)n.push(i[e]);Rs(t,(t=>{cr(e,t,n)}))}function ur(e,t){const n=Ns(t);if(n){let e=0;for(let t=0;t<n.length;t++)2!==n[t].status&&(n[e]=n[t],e++);n.length=e,Ps(t,n.length>0?n:void 0)}Rs(t,(t=>{ur(e,t)}))}function dr(e,t){const n=As(hr(e,t)),i=Ss(e.transactionQueueTree_,t);return function(e,t,n){let i=n?e:e.parent;for(;null!==i;){if(t(i))return!0;i=i.parent}}(i,(t=>{pr(e,t)})),pr(e,i),Ds(i,(t=>{pr(e,t)})),n}function pr(e,t){const n=Ns(t);if(n){const s=[];let r=[],o=-1;for(let t=0;t<n.length;t++)3===n[t].status||(1===n[t].status?(i(o===t-1,"All SENT items should be at beginning of queue."),o=t,n[t].status=3,n[t].abortReason="set"):(i(0===n[t].status,"Unexpected transaction status in abort"),n[t].unwatcher(),r=r.concat(is(e.serverSyncTree_,n[t].currentWriteId,!0)),n[t].onComplete&&s.push(n[t].onComplete.bind(null,new Error("set"),!1,null))));-1===o?Ps(t,void 0):n.length=o+1,Vs(e.eventQueue_,As(t),r);for(let e=0;e<s.length;e++)nt(s[e])}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class gr{constructor(e,t,n,i){this.eventType=e,this.eventRegistration=t,this.snapshot=n,this.prevName=i}getPath(){const e=this.snapshot.ref;return"value"===this.eventType?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+C(this.snapshot.exportVal())}}class mr{constructor(e,t,n){this.eventRegistration=e,this.error=t,this.path=n}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class vr{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return At(this._path)?null:Pt(this._path)}get ref(){return new Cr(this._repo,this._path)}get _queryIdentifier(){const e=Pn(this._queryParams),t=Qe(e);return"{}"===t?"default":t}get _queryObject(){return Pn(this._queryParams)}isEqual(e){if(!((e=R(e))instanceof vr))return!1;const t=this._repo===e._repo,n=Ot(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+function(e){let t="";for(let n=e.pieceNum_;n<e.pieces_.length;n++)""!==e.pieces_[n]&&(t+="/"+encodeURIComponent(String(e.pieces_[n])));return t||"/"}(this._path)}}class Cr extends vr{constructor(e,t){super(e,t,new Sn,!1)}get parent(){const e=Rt(this._path);return null===e?null:new Cr(this._repo,e)}get root(){let e=this;for(;null!==e.parent;)e=e.parent;return e}}class wr{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new It(e),n=Tr(this.ref,e);return new wr(this._node.getChild(t),n,on)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;return!!this._node.forEachChild(this._index,((t,n)=>e(new wr(n,Tr(this.ref,t),on))))}hasChild(e){const t=new It(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function br(e,t){return(e=R(e))._checkNotDeleted("ref"),void 0!==t?Tr(e._root,t):e._root}function Tr(e,t){var n,i,s,r;return null===kt((e=R(e))._path)?(n="child",i="path",r=!1,(s=t)&&(s=s.replace(/^\/*\.info(\/|$)/,"/")),Ws(n,i,s,r)):Ws("child","path",t,!1),new Cr(e._repo,Dt(e._path,t))}class Ir{constructor(e){this.callbackContext=e}respondsTo(e){return"value"===e}createEvent(e,t){const n=t._queryParams.getIndex();return new gr("value",this,new wr(e.snapshotNode,new Cr(t._repo,t._path),n))}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new mr(this,e,t):null}matches(e){return e instanceof Ir&&(!e.callbackContext||!this.callbackContext||e.callbackContext.matches(this.callbackContext))}hasAnyCallback(){return null!==this.callbackContext}}class Er{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t="children_added"===e?"child_added":e;return t="children_removed"===t?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new mr(this,e,t):null}createEvent(e,t){i(null!=e.childName,"Child events should have a childName.");const n=Tr(new Cr(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new gr(e.type,this,new wr(e.snapshotNode,n,s),e.prevName)}getEventRunner(e){return"cancel"===e.getEventType()?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof Er&&(this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)))}hasAnyCallback(){return!!this.callbackContext}}function kr(e,t,n,i,s){let r;if("object"==typeof i&&(r=void 0,s=i),"function"==typeof i&&(r=i),s&&s.onlyOnce){const t=n,i=(n,i)=>{nr(e._repo,e,a),t(n,i)};i.userCallback=n.userCallback,i.context=n.context,n=i}const o=new yr(n,r||void 0),a="value"===t?new Ir(o):new Er(t,o);return function(e,t,n){let i;i=".info"===kt(t._path)?os(e.infoSyncTree_,t,n):os(e.serverSyncTree_,t,n),zs(e.eventQueue_,t._path,i)}(e._repo,e,a),()=>nr(e._repo,e,a)}function Sr(e,t,n,i){return kr(e,"value",t,n,i)}!function(e){i(!Hi,"__referenceConstructor has already been defined"),Hi=e}(Cr),function(e){i(!ji,"__referenceConstructor has already been defined"),ji=e}(Cr);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Nr={};let Pr=!1;function xr(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||ze("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),He("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,h=_r(r,s),l=h.repoInfo;void 0!==pe&&(a=pe.env.FIREBASE_DATABASE_EMULATOR_HOST),a?(o=!0,r=`http://${a}?ns=${l.namespace}`,h=_r(r,s),l=h.repoInfo):o=!h.repoInfo.secure;const c=s&&o?new ot(ot.OWNER):new rt(e.name,e.options,t);Hs("Invalid Firebase Database URL",h),At(h.path)||ze("Database URL must point to the root of a Firebase Database (not including a child path).");const u=function(e,t,n,i){let s=Nr[t.name];s||(s={},Nr[t.name]=s);let r=s[e.toURLString()];r&&ze("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");return r=new Gs(e,Pr,n,i),s[e.toURLString()]=r,r}(l,e,c,new st(e.name,n));return new Rr(u,e)}class Rr{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Ks(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new Cr(this._repo,Et())),this._rootInternal}_delete(){return null!==this._rootInternal&&(!function(e,t){const n=Nr[t];n&&n[e.key]===e||ze(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ir(e),delete n[e.key]}(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&ze("Cannot call "+e+" on a deleted database.")}}Ht.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},Ht.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};!
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){Ne="9.6.10",Z(new F("database",((e,{instanceIdentifier:t})=>xr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),ie("@firebase/database","0.12.7",e),ie("@firebase/database","0.12.7","esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
ie("firebase","9.6.10","app");const Dr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(k(e,s.options)&&k(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new U(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyBSQ4EwRXTEF6Rs_3REQTWtcOoBu3HOKEQ",authDomain:"gritbook-social-media-app.firebaseapp.com",databaseURL:"https://gritbook-social-media-app-default-rtdb.europe-west1.firebasedatabase.app",projectId:"gritbook-social-media-app",storageBucket:"gritbook-social-media-app.appspot.com",messagingSenderId:"110931333305",appId:"1:110931333305:web:c540e52ab897acade50b68"})),Ar=br(Dr,"/messages"),Mr=br(Dr,"/users");Sr(Ar,(e=>{const t=e.val();console.log(t)})),Sr(Mr,(e=>{const t=e.val();console.log(t)}));
//# sourceMappingURL=index.e5d6d65f.js.map
